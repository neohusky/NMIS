...
function init() {
    ...
    window.setInterval(function(){
            ...
            formBarcode.setItemValue("Date",getDate());
            formBarcode.setItemValue("Time",getTime());
    ...
    maintoolbar.setIconsPath("images/");
...
hla.GetHotlabData = function(param){
    url = "http://" +HotlabConnectServer + ":"+ HotlabConnectPort +"/" +param;
...
hla.HotlabConnectConfig = function(){
    var dhxWins, w1,url;
    dhxWins = new dhtmlXWindows();
    url = "http://" + HotlabConnectServer +":"+ HotlabConnectPort;

    w1 = dhxWins.createWindow("w1",20,30,1120,600);
    w1.setText(url);
