...
(function ($) {
    ...
    var FORMTMPL = ['<div style="margin-left:35%; z-index:99999"><div class="riform">',
            '<form>',
                '<h1>${i18n.title}</h1>',
    ...
    function widgetLoadFromRfc5545(form, conf, icaldata, force) {
        ...
        if (form.ical.RRULE === undefined) {
			...
			if(monthlyType==radiobutton.value){
    ...
    function RecurrenceInput(conf, textarea) {
        ...
        function recurrenceOn() {
			...
			$("textarea[name=rrule]").text(widgetSaveToRfc5545(form, conf, false).result);
			
        }

		function gethumanreadable(taskid) {
            var RFC5545 = widgetSaveToRfc5545(form, conf, false);
            ("#rrule"+taskid).val(RFC5545.description);		
        }
