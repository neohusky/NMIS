...
# Database: NMIS
# Generation Time: 2015-12-30 05:52:33 +0000
# ************************************************************
...
# Dump of table kittypes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `kittypes`;

CREATE TABLE `kittypes` (
  `Kit ID` int(11) NOT NULL AUTO_INCREMENT,
  `Supplier` varchar(50) NOT NULL,
  `Trade name` varchar(30) DEFAULT NULL,
  `Abbreviation` varchar(20) NOT NULL,
  `Radiopharmaceutical` varchar(100) NOT NULL,
  `Kit size` varchar(20) DEFAULT NULL,
  `Reconstituting isotope` varchar(25) DEFAULT NULL,
  `Expiry time post preparation` int(11) DEFAULT NULL,
  `Special reconstitution requirements` varchar(255) DEFAULT NULL,
  `Recommended reconstitution activity` int(11) DEFAULT NULL,
  `Minimum reconstitution activity` int(11) DEFAULT NULL,
  `Maximum reconstitution activity` int(11) DEFAULT NULL,
  `Minimum reconstitution volume` float DEFAULT NULL,
  `Maximum reconstitution volume` float DEFAULT NULL,
  `Recommended reconstitution volume` float DEFAULT NULL,
  `Requires reconstitution` tinyint(1) NOT NULL DEFAULT '0',
  `Kit re-order threshold` tinyint(4) DEFAULT NULL,
  `QC requirements` longtext,
  `Inherent kit volume` float DEFAULT '0',
  `Requires QC pass` tinyint(1) DEFAULT '0',
  `Manufacture Comments` longtext,
  PRIMARY KEY (`Kit ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
